<header class="text-white text-2xl flex flex-col pt-4 items-center mr-8 xl:m-0 xl:items-start">
    <div class="fa-brands fa-twitter fa-2x hover:text-gray-500">
    </div>
    ...
    <div>
        <button class="hidden bg-blue-500 text-xl text-white font-bold mt-8 mr-12 py-4 px-24 rounded-full xl:block">
            Tweet
        </button>

        <button class="bg-blue-500 mt-8 p-3 rounded-full xl:hidden">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
