<x-layout>
    ...
    <div class="container mx-auto md:w-[600px]  ">
        <h1 class=" border-x border-gray-700 text-white font-bold text-2xl p-5 ">Home</h1>
        ...
        <div class="flex border-b border-x border-gray-700 px-2 py-1 text-white">
            ...
            <div class="pl-2 pt-3 w-full">
                <form action="#" method="POST">
                    ...
                    <div class="relative">
                        <input
                            type="text"
                            name="searchQuery"
                            class="background text-xl text-white pb-6"
                ...
                <div class="flex justify-between pt-4">
                    ...
                    <a href="/posts/create" class="bg-blue-500 rounded-full text-white px-6 py-2 mr-4 mb-4">Tweet</a>
                </div>
            </div>
        </div>
        ...
        @foreach ($posts as $post)
            <article class=" border-b border-x border-gray-700 px-3 py-3 text-white text-base">
                <div class="flex">
                    ...
                    <div class="pl-4">
                        <div class="flex">
                            <a href="/posts/{{ $post->id }}/edit" class="font-bold">{{ $post->name }}</a> 
                            ...
                            <p class="ml-1 text-gray-500">@</p>
                            <p class="text-gray-500">{{ $post->handle }} · 2h</p> 
                        </div>
