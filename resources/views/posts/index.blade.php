<x-layout>
    ...
    <div class="container mx-auto pt-4 md:w-[600px]">

        <div class="mb-2 flex border-b border-gray-700 px-2 py-1 text-white">
            <div>
            ...
            <div class="pl-2">
                <form action="#" method="POST">
                    ...
                    <div class="relative">
                        <input
                            type="text"
                            name="searchQuery"
                            class="background text-xl text-white"
                ...
                <div class="flex justify-between border border-red-500">
                    ...
                    <a href="/posts/create" class="bg-blue-500 tracking-wide text-white px-6 py-2 inline-block shadow-lg rounded hover:shadow">Tweet</a>
        ...
        @foreach ($posts as $post)
            <article class="mb-2 flex border-b border-gray-700 px-2 py-1 text-white">
                <div>
                    <div class="w-12 rounded-full img-background">
                        <img src="{{asset('images/profile-test.jpg')}}" class="rounded-full w-12" alt="">
                    </div>
